  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="text-white">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold">My Bookings</h1>
              <p className="text-white/90 mt-2 text-sm sm:text-base truncate max-w-full">{email}</p>
            </div>
            <Button
              variant="secondary"
      ...
      <Tabs defaultValue="upcoming" className="w-full">
        ...
        <TabsContent value="upcoming" className="space-y-3 sm:space-y-4 mt-6">
          {upcomingAppointments.length === 0 ? (
            <Card>
              <CardContent className="py-12 text-center text-muted-foreground text-sm sm:text-base">
              ...
              <Card key={appointment.id} className="hover:shadow-xl transition-all hover:scale-[1.01] border-2 hover:border-primary/20">
                ...
                <CardContent className="space-y-2 sm:space-y-3 p-4 sm:p-6 pt-0">
                  <div className="flex items-center gap-2 text-xs sm:text-sm">
                    ...
                    <span className="truncate">{format(new Date(appointment.date), "MMMM d, yyyy")}</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs sm:text-sm">
                  ...
                  <div className="flex items-center gap-2 text-xs sm:text-sm">
                    ...
                    <span className="truncate">{appointment.branch?.name}</span>
                  </div>
                  {appointment.notes && (
